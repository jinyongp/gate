...
export async function assertDNSAllowed(service: string, options: GateCommandOptions & { dns?: GateDNSMode }): Promise<void> {
...
export function resolveServiceDomain(config: ProjectConfig, serviceName: string): string | undefined {
